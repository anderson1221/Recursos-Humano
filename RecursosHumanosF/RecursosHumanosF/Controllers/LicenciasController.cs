...
namespace RecursosHumanosF.Controllers
{
    public class LicenciasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Empleado,Desde,Hasta,Motivo,Comentarios")] Licencia licencia)
        {

            var x = licencia.Empleado;
            ...
            ViewBag.Empleado = new SelectList(db.Empleados, "ID", "Nombre", licencia.Empleado);
            return View(licencia);
        }
